...
<ul class="sub-menu">
	...
	<li id="menu-item-243" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-243"><a href="tiffiny.php">Tiffinys</a></li>
</ul>
</li>
...
<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-243"><a href="tiffiny.php">Tiffinys/a></li>
</ul>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-251"><a href="contact.php">Contact Us</a>
 ...
 <!--===============================================================header ends===============================================================-->   
    <div class="canvas">		
            ...
            <div id="searchmain">
               		<div id="searchbox" style="width:auto;float:right;margin-left:5%;padding:10px; ">
<form action="reserve.php" method="post" name="search">
  ...
  <tr>
	...
	<td colspan="2">
	<input name="arrivaldate_datepicker" type="text" class="required" id="arrivaldate_datepicker" title="Please select a date!"  size="20" maxlength="30" style="width:70px;padding:0px;"  /><img src="images/icon_cal_start.gif" style="margin-top:5px;margin-left:5px;" /></td>
	<td colspan="2" align="left">
	<input name="departuredate_datepicker" type="text" class="required" id="departuredate_datepicker" title="Please select a date!" value="<?echo $tomorrow_date;?>" value="<?=$_POST[departuredate_datepicker]?>" size="20" maxlength="30" style="width:70px;padding:0px;" /> <img src="images/icon_cal_start.gif" style="margin-top:5px;margin-left:5px;" /></td>
    </tr>
	 <tr>
...
<div class="button-standard button">
  ...
  <tr>
    ...
    <td align="left"><strong><li><a href="tiffiny.php" style="color:#2d1912;">	TIFFINYS&nbsp;</a></li></strong></td>
  </tr>
</table>
</p>
