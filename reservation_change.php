										...
										$Room_Description='<tr>
										  ...
										  ?> 
                                           <?
                                              ...
                                              <td>Room Description</td>
                                              <td>
                                             <p>Our top of the line accommodation, the Grand Suites are the best place to stay in Coimbatore. Its classical d�cor will never look dated; with all the amenities that is sure to meet everyone�s expectations, it is the ideal choice for anyone who wants to treat themselves to ultimate luxury. </p>                                        
											</td>
                                            </tr>
                                              <tr>
                                              <td style="vertical-align:middle;">Room Facilities</td>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-251"><a href="contact.php">Contact Us</a>
 ...
 <!--===============================================================header ends===============================================================-->   
            ...
            <div class="content-container">
                    ...
                    <div class="rail-content left">
						...
						<?php		
							if($_POST['edt_submit'])
							{
								if($_POST['edt_email']=="") { $_POST['edt_email']=$_SESSION['edt_email'];  }
	...
	<table width="75%" border="0" cellpadding="0" cellspacing="0" class="reserveinnerbox" style="margin-left:6px">
                      <tbody>
						<tr>
						  ...
						  <tr>
	<td>
	<input name="arrivaldate_datepicker" type="text" class="required" id="datepicker_checkin1" title="Please select a date!"  size="20" maxlength="30" style="width:70px;padding:0px;background-color: #fff;color: #000;" value="<?php echo $res_edt['Arrival'];?>"  /><img src="images/icon_cal_start.gif" style="margin-top:5px;margin-left:5px;" /></td>
	...
	<td>
	<input name="departuredate_datepicker" type="text" class="required" id="datepicker_checkout1" title="Please select a date!" value="<?php echo $res_edt['Departure'];?>" size="20" maxlength="30" style="width:70px;padding:0px;background-color: #fff;color: #000;" /> <img src="images/icon_cal_start.gif" style="margin-top:5px;margin-left:5px;" />
    ...
    <td align="left">
	<input id="numDays1" name="nights" value="<?php echo $res_edt['Nights'];?>" style="padding: 0px;width: 15px;background-color: #fff;color: #000;text-align: center;" readonly />
	</td>
    </tr>
						</tbody>
	</table>
	<table width="100%" border="0" cellpadding="5" cellspacing="5" class="reserveinnerbox" >
                      <tbody>
						...
						<tr>
                          ...
                          <td>
                           <input name="lastname" type="text" id="lastname" tabindex="1" value="<?php echo $res_edt['Lastname'];?>" size="15" maxlength="14" style="padding:0px;background-color: #fff;color: #000;" >                          	   </td>
                          <td>
                              <input name="firstname" type="text" id="firstname" tabindex="1" value="<?php echo $res_edt['Firstname'];?>" size="15" maxlength="15" style="padding:0px;background-color: #fff;color: #000;" >                          </td>
                        </tr>
                        </tbody>
	</table>
	<table width="100%" border="0" cellpadding="5" cellspacing="5" class="reserveinnerbox">
                        ...
                        <tr>
                          <td>Telephone *<br>
							<input name="riddb" type="hidden" value="<?=$_POST[edt_email]?>">
                              <input name="telephone" type="text" id="telephone" tabindex="3" value="<?php echo $res_edt['Telephone'];?>" size="15" maxlength="15" style="padding:0px;background-color: #fff;color: #000;">                          </td>
                          <td>Fax<br>
                              <input name="fax" type="text" id="fax" tabindex="4" value="<?php echo $res_edt['Fax'];?>" size="15" maxlength="15" style="padding:0px;background-color: #fff;color: #000;">                          </td>
                          <td colspan="2">E-mail *<br>
                              <input name="email" type="text" id="email" tabindex="5" value="<?php echo $res_edt['Email'];?>" size="35" maxlength="50" style="padding:0px;background-color: #fff;color: #000;">                          </td>
                        </tr>
                        <tr>
                          <td colspan="2">Address *<br>
                          <input name="address" type="text" id="address" tabindex="7" value="<?php echo $res_edt['Address'];?>" size="38" maxlength="60" style=";padding:0px;background-color: #fff;color: #000;"></td>
                          <td>City *<br>
                              <input name="city" type="text" id="city" tabindex="9" value="<?php echo $res_edt['City'];?>" size="15" maxlength="20" style="padding:0px;background-color: #fff;color: #000;">                          </td>
	                    </tr>
                        <tr>
                          <td>Postal Code *<br>
                              <input name="pincode" type="text" id="pincode" tabindex="8" value="<?php echo $res_edt['PostalCode'];?>" size="10" maxlength="10" style="width:100px;padding:0px;background-color: #fff;color: #000;">
                          </td>
                          <td colspan="3">Country *<br>
                            <input name="country" type="text" id="country" tabindex="9" value="<?php echo $res_edt['Country'];?>" size="15" maxlength="20" style="padding:0px;background-color: #fff;color: #000;">                                                  </td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td colspan="3">&nbsp;</td>
  ...
  <tr>
	<td width="13%" style="text-align:right;"><a href="modify.php?edit_id=1">BACK</a></td>
    <td width="74%">&nbsp;</td>
    <td width="13%" style="text-align:right;"><input type="submit" name="STEPTWO" id="STEPTWO" value="Continue"></td>
								...
								echo "<a href=\"modify.php?edit_id=1\">BACK</a>";
								}
							}?>
   ...
   <h3>Reservation Summary</h3>
                                       ...
                                       <table border="0" class="reserveinnerbox" width="100%" cellspacing="5" cellpadding="5">
                                          <tbody>
                                            ...
                                            <tr>
                                              <td>Arrival / Departure </td>
                                              <td><?php echo $res_edt['Arrival'];?> - <?php echo $res_edt['Departure'];?> </td>
                                            </tr>
                                            <tr>
                                              <td>Number of Night(s) </td>
                                              <td><?=$_POST[nights]?></td>
