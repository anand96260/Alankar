 ...
 <!--===============================================================header ends===============================================================-->   
     ...
     <div class="canvas">		
        <header class="page-header">
            <h1>Welcome to Hotel Alankar Grande - Reservation Thanks</h1>
        </header><!-- page-header -->
...
<h4 align="center">Thank you for choosing Hotel Alankar Grande as your preferred choice.</h4>
<div style="margin-left:40%;">
<p>
Your reservation is confirmed at:</p>
<p>
<strong>Hotel Alankar Grande</strong><br>
No. 10, Sivasamy Road,<br>
Ramnagar,<br>
Coimbatore,<br>
Tamil Nadu  641009<br>
Phone : 0422 437 8888</p><br><br>
