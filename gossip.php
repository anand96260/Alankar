			...
			jQuery(function($){
				...
				jQuery.supersized({				
					...
					slides: [
																																	...
																																	{image: 'files/gossip/gossip1.jpg', title : ''},								
										
																																	{image: 'files/gossip/gossip2.jpg', title : ''},								
										
																																	{image: 'files/gossip/gossip3.jpg', title : ''},								
										
																																	{image: 'files/gossip/gossip4.jpg', title : ''},								
						
																																	{image: 'files/gossip/gossip5.jpg', title : ''}								
										]
...
<ul class="sub-menu">
	<li id="menu-item-245" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item menu-item-245"><a href="gossip.php">Gossip</a></li>
 ...
 <!--===============================================================header ends===============================================================-->    
     <div class="canvas">		
        <header class="page-header">
            <h1>Welcome to Hotel Alankar Grande - Restaurant - Gossip</h1>
        </header><!-- page-header -->
