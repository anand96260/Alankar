                ...
                <div class="page-left left">
                    ...
                    <div class="rail-content left">
						...
						<?php
							if($_POST['view_submit'])
							{
								$view_sql=mysql_query("select * from booking where rid='".$_POST['view_email']."' ");
									   ...
									   <table border="0" class="reserveinnerbox" width="100%" cellspacing="5" cellpadding="5">
                                          <tbody>
											...
											<tr>
											  ...
											  <td style="margin-left:5px;"><?php echo $content; ?></td>
                                              </tr>
                                        
                        <tr>
                          <td colspan="2"><h4 style="border-bottom:1px solid #9c8659;padding:0px;">Guest Name</h4> </td>
                        </tr>
                        <tr>
                          <td colspan="2"><?php echo $res_view['Title'].'.'.$res_view['Firstname'].'&nbsp;'.$res_view['Lastname'];?></td>
                        </tr>
                        <tr>
                          <td colspan="2"><h4 style="border-bottom:1px solid #9c8659;padding:0px;">Guest Contact Details</h4> </td>
                        </tr>
                        <tr>
					...
					<div align="center">
					 <input type="button" value="Print" onClick="PrintDiv();" class="button" />
					</div>
               <?php }
			   else
			   {
			   echo "<h3>Guest Information for Reservation ID:".$_POST['view_email']." does not exit or Canceled.<br>Sorry for any inconvenience caused.</h3>";			
			   }
			   }
			   ?>
