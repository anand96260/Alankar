...
<div class="wrapper">
    <div class="errorPage">
        ...
        <p>Oops! Sorry, an error has occured. Internal Server Error!</p>
        <div class="backToDash"><a href="index.php" title="Back to Dashboard" class="seaBtn button">Back to Dashboard</a></div>
    </div>
</div>
