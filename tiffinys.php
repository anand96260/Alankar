...
{
header("Location: download_tiffinys.php");
}
?>
<!doctype html>  
...
<!--[if (gt IE 9)|!(IE)]><!--><html class="no-js" dir="ltr" lang="cs-CZ"> <!--<![endif]-->
    ...
    <![endif]-->
    <title>Welcome to Hotel Alankar Grande - Restaurants - Tiffinys</title>
			...
			jQuery(function($){
				...
				jQuery.supersized({				
					...
					slides: [
																																	...
																																	{image: 'files/tiffiny/tiffiny1.jpg', title : ''},								
																	
										
																																	{image: 'files/tiffiny/tiffiny2.jpg', title : ''}								
										]
...
<ul class="sub-menu">
	...
	<li id="menu-item-243" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item menu-item-243"><a href="tiffinys.php">Tiffinys</a></li>
</ul>
</li>
...
<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item menu-item-243"><a href="tiffinys.php">Tiffinys</a></li>
</ul>
 ...
 <!--===============================================================header ends===============================================================-->    
     <div class="canvas">		
        <header class="page-header">
            <h1>Welcome to Hotel Alankar Grande - Restaurant - Tiffinys</h1>
        </header><!-- page-header -->
  ...
  <tr>
    ...
    <td width="20%" ><input type="submit" name="download" id="download" value="Download Our Menu card" class="button"><!--<a href="download_gossip.php" Class="button">Download Our Menu card </a>--></td>
                                        ...
                                        <iframe src="http://docs.google.com/viewer?url=http%3A%2F%2Fwww.oxygencreations.com%2Falankar1%2Fpdf%2Ftiffinys.pdf&embedded=true" width="600" height="780" style="border: none;"></iframe>
                                         <?php /*?>   
                                        <?  $next=$page+1;
                                        	$prev=$page-1;
										?>
                                        ...
                                        <? if($page!=1)
										{ ?>
                                        <a href="tiffinys.php?page=<?=$prev?>">Prev</a>&nbsp;&nbsp;
                                        <? } ?>
                                        <? if($page!=4) { ?>
                                        &nbsp;&nbsp;<a href="tiffinys.php?page=<?=$next?>">Next</a>
                                        <? } ?>
                                        </p> 
                                        
                                        <? if($page==1) { ?>  
                                       <img src="images/Tiffiny1.png" width="700" > 
                                       <? } ?>
                                       <? if($page==2) { ?>
                                       <img src="images/Tiffiny2.png" width="700" >
                                       <? } ?>
                                       <? if($page==3) { ?> 
                                       <img src="images/Tiffiny3.png" width="700" > 
                                       <? } ?>
                                       <? if($page==4) { ?>
                                       <img src="images/Tiffiny4.png" width="700" > 
                                       <? } ?> 
